"""
Django settings for ilmiy_jurnal project.
"""
...
ROOT_URLCONF = 'ilmiy_jurnal.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pages.context_processors.site_i18n',
...
STATICFILES_DIRS = []  # Faqat pages/static/ (app static) ishlatiladi
...
JAZZMIN_SETTINGS = {
    ...
    "search_model": ["pages.News", "pages.Announcement", "pages.Volume"],
    "user_avatar": None,
    "topmenu_links": [
        {"name": "Bosh sahifa", "url": "admin:index", "permissions": ["auth.view_user"]},
        {"name": "Saytni ko'rish", "url": "/", "new_window": True},
        {"name": "👥 Foydalanuvchilar", "url": "/admin-panel/foydalanuvchilar/", "permissions": ["auth.view_user"]},
        {"name": "🔬 Taqrizchilar", "url": "/admin-panel/taqrizchilar/", "permissions": ["auth.view_user"]},
    ],
    ...
    "icons": {
        ...
        "pages.EditorialMember": "fas fa-users",
        "pages.News": "fas fa-newspaper",
        "pages.Announcement": "fas fa-bullhorn",
        "pages.RegulatoryDocument": "fas fa-file-contract",
        "pages.Volume": "fas fa-book",
        "pages.VolumeArticle": "fas fa-file-pdf",
    },
